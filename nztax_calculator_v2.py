...
monthly_deductions_2 = get_float_input("Enter your ACC Percent Contribution (e.g 2): ") / 100
...
print("==========================================================================")
print(f"Monthly Take-Home Pay: ${monthly_net_income:,.2f}")
print("==========================================================================")
print(f"Fortnightly Take-Home Pay: ${fortnightly_net_income:,.2f}")
print("==========================================================================")
